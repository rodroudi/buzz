...
pub enum ChannelsCmd {
    ...
    Update {
        ...
        #[arg(long)]
        description: Option<String>,
        /// New channel visibility. `open` lets any relay member read and post
        /// without joining; `private` restricts access to explicit members.
        /// Requires the caller to be a channel owner or admin.
